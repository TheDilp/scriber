...
export default defineConfig([
  globalIgnores(['dist', 'node_modules', '.vscode', '.claude', '.agents', 'docs', 'scripts', '.localstorage.*']),
   {
      files: ["**/*.{ts,tsx}"],
      extends: [
      ...
      rules: {
        ...
        "perfectionist/sort-arrays": [
          ...
          },
          {
            useConfigurationIf: {
              matchesAstSelector:
                'VariableDeclaration[kind="const"] > VariableDeclarator[id.name=/Enum$/] > ArrayExpression',
            },
            type: "unsorted",
          },
        ],
        ...
        "perfectionist/sort-objects": [
          "error",
          {
            useConfigurationIf: {
              matchesAstSelector:
                "CallExpression[callee.name=/^tv$/] ObjectExpression",
            },
            type: "unsorted",
          },
          {
        ...
        "perfectionist/sort-union-types": [
          "error",
          {
            useConfigurationIf: {
              matchesAstSelector:
                "TSTypeAliasDeclaration[id.name=/^(Variant|Size)$/] > TSUnionType",
            },
            type: "unsorted",
          },
          {
